...
const terms: Terms = {
  ...
  feature1d: {
    ...
    fa: 'به طور مستقل کنترل حضور آنلاین خود را بدست آورید و بدون وابستگی به یک مرجع مرکزی عمل کنید.',
  },
  feature2: {
    en: 'Customizable',
    fa: 'پروفایل قابل تنظیم',
  },
  feature2d: {
    en: 'Personalize your profile to reflect your unique identity and branding.',
    fa: 'پروفایل خود را به شکلی شخصی‌سازی کنید تا هویت و برند شخصی خود را بازتاب دهد.',
  },
  feature3: {
    en: 'Unified Links',
    fa: 'لینک‌های یکپارچه',
  ...
  feature3d: {
    ...
    fa: 'لینک‌های متعدد خود را در یک محور یکپارچه قرار دهید تا ناوبری بی‌درزی را تجربه کنید.',
  },
  feature4: {
  ...
  feature4d: {
    ...
    fa: 'امکان ناوبری بی‌درز برای بازدیدکنندگان را فراهم کنید تا به آسانی و بدون انقطاع در پلتفرم‌های آنلاین شما حرکت کنند.',
  },
  feature5: {
  ...
  feature7d: {
    ...
    fa: 'حضور و قابلیت مشاهده آنلاین خود را برای یک جمعیت بزرگتر افزایش دهید.',
  },
  feature8: {
    en: 'Transparency',
    fa: 'شفاف',
  ...
  feature8d: {
    ...
    fa: 'برای مدیریت هویت آنلاین خود، یک محیط شفاف و امن را تضمین کنید.',
  },
  feature9: {
    en: 'User Empowerment',
    fa: 'توانمندسازی کاربر',
  },
  feature9d: {
  ...
  watis3: {
    ...
    fa: 'ان اف تی ها و دارایی های کریپتویی شما ',
  },
  watis4: {
  ...
  manageDescription: {
    ...
    fa: 'راحتی مدیریت حضور آنلاین را تجربه کنید',
  },
  dappDescription: {
  ...
  profileDescription: {
    ...
    fa: 'پروفایل سفارشی شما در بلاکچین',
  },
  linkDescription: {
  ...
  confirmingTx: {
    ...
    fa: 'در حال تایید تراکنش در بلاکچین ...',
  },
  confirmInWallet: {
